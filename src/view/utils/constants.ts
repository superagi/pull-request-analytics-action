...
export const cursorLinesAddedHeader = "Cursor lines added";
export const cursorLinesDeletedHeader = "Cursor lines deleted";
export const cursorAcceptedLinesAddedHeader = "Cursor accepted lines added";
export const cursorAcceptedLinesDeletedHeader = "Cursor accepted lines deleted";
